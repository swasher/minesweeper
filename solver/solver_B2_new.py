...
def solver_B2_new(matrix) -> [Turn]:
    ...
    r1 = roots[0]
    r2 = roots[1]
    set(r1.closed).issubset(set(r2.closed))  => True если r1 входит в множество r2
    ...
    for r1, r2 in itertools.combinations(roots, 2):
        ...
        if set1.issubset(set2) or set2.issubset(set1):
            ...
            if diff_len and (diff_len == diff_number):
                ...
                for b in bombs:
                    t = Turn(cell=b, probability=probability, solver=solver_B2_new.__name__)
                    turns.append(t)
