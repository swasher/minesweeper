...
class Turn:
    cell: Cell
    probability: float  # рассчитанная вероятность мины
    ...
    effectiveness: float = None  # эффективность нажатия (напр., сколько ячеек откроется при нажатии). Можно выбирать сначала более эффективные нажатия
