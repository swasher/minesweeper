from . import minesweeper as mnsw
import time
...
def read_board(encoded_board, total_mines, everything_mode=False) -> tuple[list["Rule"], "MineCount"]:
...
def generate_rules(board, total_mines, everything_mode=False) -> tuple[list["Rule"], "MineCount"]:
