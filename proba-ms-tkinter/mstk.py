...
def create_board(board, actualBoard, coordinates, vis, buttonsclear, mineCount, dimensions):
    ...
    def handle_left_click(value, buttons):
        ...
        if value not in disabledbuttons:
            ...
            if playerClicks(row, col, board, actualBoard, vis, mineCount, buttons, buttonsclear,
                            disabledbuttons) == "Lost":
                ...
                if response:  # If "Yes" is clicked
                    ...
                    close()
            elif playerClicks(row, col, board, actualBoard, vis, mineCount, buttons, buttonsclear,
                              disabledbuttons) == 'Win':
